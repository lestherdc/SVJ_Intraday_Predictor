...
# Configuracion real-time
REFIT_INTERVAL_MIN = 15 # recalibra cada 15 min, recuerda que trabajamos en velas de 5, 15 y 30
...
try:
    while True:
        ...
        # Rolling window: últimas 500 velas (ajusta si quieres)
        window_size = 500
        ...
        log_returns_window = np.log(closes_window[1:] / closes_window[:-1])
